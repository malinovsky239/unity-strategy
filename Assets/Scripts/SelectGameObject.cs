...
public class SelectGameObject : MonoBehaviour
{
    ...
    private void ZoomCamera()
    {
        ...
        fieldOfView -= Input.GetAxis("Mouse ScrollWheel") * ScaleSensitivity;
    ...
    private void RotateCamera()
    {
        ...
        transform.RotateAround(rotationAxisBase, Vector3.up, Input.GetAxis("Mouse X") * Time.deltaTime * RotateSensitivity);
    }
